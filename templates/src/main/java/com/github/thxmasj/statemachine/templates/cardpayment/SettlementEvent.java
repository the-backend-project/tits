...
public class SettlementEvent {
  ...
  public enum Type implements EventType {
    ...
    SettlementApproved(UUID.fromString("c65e15fd-0b97-4e99-bc57-7ef3385e33d7"), AcquirerResponse.class),
    InBalance(UUID.fromString("95a4e74c-e3ec-49a3-976e-28d14f0e41f6"), String.class),
    OutOfBalance(UUID.fromString("2ea23e6e-e11b-4fd9-88e6-8a8f18c9c086"), String.class),
