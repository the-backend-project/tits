...
public interface SettlementEvent {
  ...
  EventType<Void, Void> Open =
      BasicEventType.of("Open", UUID.fromString("c7d16033-fdc0-499a-b92c-18e07caf93f2"));
  ...
  EventType<Void, AcquirerBatchNumber> GetAcquirerBatchNumber =
      BasicEventType.of("GetAcquirerBatchNumber", UUID.fromString("01700fc1-fa15-4142-a673-ba0e9a2768b6"), Void.class, AcquirerBatchNumber.class);
  EventType<Void, BatchNumber> GetBatchNumber =
      BasicEventType.of("GetBatchNumber", UUID.fromString("ad4a9ec8-d0e6-44ce-bef3-d2bd20709005"), Void.class, BatchNumber.class);
