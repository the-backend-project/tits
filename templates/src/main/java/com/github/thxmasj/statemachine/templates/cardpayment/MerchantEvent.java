...
public interface MerchantEvent {
  ...
  EventType<Merchant, Merchant> Create = BasicEventType.of("Create", UUID.fromString("845449d2-d6da-478c-bb98-eac7bcaa4326"), DataType.forClass(Merchant.class));
  ...
  EventType<MerchantUpdate, Merchant> Update = BasicEventType.of("Update", UUID.fromString("2119043f-d547-4b68-ab76-6644662e26ea"), DataType.forClass(MerchantUpdate.class), DataType.forClass(Merchant.class));
  EventType<Void, Merchant> Get = new ReadOnly<>("Get", UUID.fromString("419b02d4-ad02-4cdf-a0a9-e20ffd3ad45f"), DataType.none(), DataType.forClass(Merchant.class));
