...
public interface PaymentEvent {
  ...
  EventType<Refund, AcquirerRefund> ValidRefundRequest = RequestEventType.of("Valid refund request", UUID.fromString("94513e5a-1ded-4379-9087-16a148903bb5"), Refund.class, AcquirerRefund.class);
