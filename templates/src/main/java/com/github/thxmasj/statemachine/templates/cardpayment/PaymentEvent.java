...
public interface PaymentEvent {
  ...
  EventType<Tuple2<Authorisation, String>, Authorisation> PaymentRequest = EventType.of("PaymentRequest", UUID.fromString("bf2eaeb5-cd26-4e5a-873e-f6d308387ec3"), new DataType<>(Authorisation.class, String.class), Authorisation.class);
  ...
  EventType<AuthenticationResult, Void> InvalidAuthenticationToken = EventType.of("InvalidAuthenticationToken", UUID.fromString("de24bd56-5ad1-4b1e-b567-8eb719c0ff51"), AuthenticationResult.class, Void.class);
  ...
  EventType<Void, Long> RollbackRequest = EventType.rollback("RollbackRequest", UUID.fromString("da2d5fd5-beb7-4497-87f7-479ba7eb2a66"));
