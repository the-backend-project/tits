...
public class PaymentEvent {
  ...
  public enum Type implements EventType {
    ...
    PreauthorisationRequest(UUID.fromString("ead7e832-3d32-407b-8316-b23023e8217c"), AuthenticationResult.class),
    ...
    AuthorisationRequest(UUID.fromString("4391c1cf-1cda-4627-9d9d-fe8b18b8b6cb"), AuthenticationResult.class),
