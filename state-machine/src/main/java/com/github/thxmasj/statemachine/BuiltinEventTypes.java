...
public interface BuiltinEventTypes {
  ...
  EventType<Void, State> Status = new ReadOnly<>("Status", UUID.fromString("324dc75d-e83d-4b9b-8ad9-b3521184def6"), State.class);
  EventType<Tuple3<Change, SecondaryId, EventLog>, Void>
      SecondaryIdAlreadyExists = of("SecondaryIdAlreadyExists", UUID.fromString("d94ce75c-cb6a-41cd-a652-a210e6de1516"), new DataType<>(Change.class, SecondaryId.class, EventLog.class), Void.class);
